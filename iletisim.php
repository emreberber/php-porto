				...
				<div class="container">
					<div class="row pt-xl">
						<div class="col-md-7">
							...
							<p class="lead mb-xl mt-lg">Bize ulaşmak için aşağıdaki formu eksiksizce doldurunuz.</p>
						...
						<div class="col-md-4 col-md-offset-1">
							...
							<ul class="list list-icons list-icons-style-3 mt-xlg mb-xlg">
								<li><i class="fa fa-map-marker"></i> <strong>Adress:</strong> <?php echo $ayarcek['ayar_adres']; ?><br><?php echo $ayarcek['ayar_ilce']; ?>/<?php echo $ayarcek['ayar_il']; ?></li>
