					...
					<div class="container">
						<div class="row mb-xl">
							...
							if($sayi>5) { ?>
								...
								<p class="mt-lg"><?php echo substr($hakkimizdacek["hakkimizda_vizyon"],0,450) ?></p>
							</div>
							...
							<?php } else {  ?>
								...
								<p class="mt-lg"><?php echo substr($hakkimizdacek["hakkimizda_misyon"],0,450) ?></p>
							</div>
...
-->
								...
								<div class="col-md-12">
									<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
										<span class="thumb-info-side-image-wrapper p-none ">
												...
												<img src="<?php echo $icerikcek['icerik_resimyol']; ?>" class="img-responsive" alt="" style="width: 195px; padding:10px;">
				...
				<section class="section section-background section-footer" style="background-image: url(img/custom-header-bg-2.jpg); background-position: 100% 100%;">
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-md-offset-6">
								<h2 class="mt-xl mb-none">Bir Mesaj Bırakın...</h2>
								<p>Geri bildirimleriniz bizim için önemlidir.$_REQUEST</p>
								<div class="divider divider-primary divider-small mb-xl">
									<hr>
								</div>
