...
include 'nedmin/production/func.php';

//AYAR TABLOSUNA BAGLANMA
								...
								<form id="searchForm" action="arama.php" method="POST">
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button class="btn btn-default" name="aranan" type="submit"><i class="icon-magnifier icons"></i></button>
										</span>
									</div>
								</form>
							</div>
								...
								<nav>
									...
									$menusor->execute(array(
                         			 ...
                         			 { 
										...
										<li class="<?php if($say>0) echo 'dropdown' ?>">
											<a href="<?php 
